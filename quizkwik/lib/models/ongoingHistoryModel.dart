...
class OngoingHistoryModel extends StatefulWidget {
  const OngoingHistoryModel({Key? key}) : super(key: key);

  @override
  State<OngoingHistoryModel> createState() => _OngoingHistoryModelState();
}

class _OngoingHistoryModelState extends State<OngoingHistoryModel> {
  @override
