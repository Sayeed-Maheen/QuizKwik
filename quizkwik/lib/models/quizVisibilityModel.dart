...
class QuizVisibilityModel extends StatefulWidget {
  const QuizVisibilityModel({Key? key}) : super(key: key);

  @override
  State<QuizVisibilityModel> createState() => _QuizVisibilityModelState();
}

class _QuizVisibilityModelState extends State<QuizVisibilityModel> {
