...
class PlayQuizButton extends StatefulWidget {
  final void Function()?
  ...
  @override
  State<PlayQuizButton> createState() => _PlayQuizButtonState();
}

class _PlayQuizButtonState extends State<PlayQuizButton> {
  @override
